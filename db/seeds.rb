...
User.create!(email: "test@test.com", password: "password", first_name: "Molly", last_name: "McTesty",
             about_me: "I like to cook and share it with the world. All my meals are vegan and super convenient")
User.create!(email: "a@b.com", password: "password", first_name: "Albert", last_name: "test",
...
Listing.create!(title: "Fluffy Pancakes", description: "It’s been lovely. My pancake endeavors have paid off, too.
    I realized the other day that I don’t have a basic pancake recipe on the blog, so here we are.Meet my new favorite pancake recipe. It’s easy, healthy and vegan, to boot!", price: 10, qty: 4, user_id: 1, location_id: 1)
Listing.create!(title: "Buddha Bowl",
                description: "Super yummi food that is raw and will fill you up for 3 days. highly reccomend, my absolute favorite, now my family eats olny 3 meals per week, real money saver", price: 12.50, qty: 2, user_id: 2, location_id: 2)
